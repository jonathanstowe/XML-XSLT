...
is($out, slurp_file("$Bin/test_data/testsuite/TESTS/Xalan_Conformance_Tests/REF_OUT/attribset/attribset05.out"),"output is as expected");
...
is($out, slurp_file("$Bin/test_data/testsuite/TESTS/Xalan_Conformance_Tests/REF_OUT/attribset/attribset06.out"),"output is as expected");
...
is($out, slurp_file("$Bin/test_data/testsuite/TESTS/Xalan_Conformance_Tests/REF_OUT/attribset/attribset09.out"),"output is as expected");
...
is($out, slurp_file("$Bin/test_data/testsuite/TESTS/Xalan_Conformance_Tests/REF_OUT/attribset/attribset31.out"),"output is as expected");
...
is($out, slurp_file("$Bin/test_data/testsuite/TESTS/Xalan_Conformance_Tests/REF_OUT/attribset/attribset32.out"),"output is as expected");
